...
public class TeamBuildingPackageItemValidator {
    ...
    public TeamBuildingPackageItemValidator(ITeamBuildingPackageItemRepository teamBuildingPackageItemRepository, ITeamBuildingPackageRepository teamBuildingPackageRepository, IActivityRepository activityRepository, IActivityMutexRepository activityMutexRepository, IActivityDependentRepository activityDependentRepository) {
