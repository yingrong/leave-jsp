...
@WebServlet(value = "/todo-list/vue-cli-basic")
public class TodoVueCliBasicServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if ("get".equals(sAction)) {
            ...
            request.getRequestDispatcher("/todo_list/vue_cli_basic/dist/index.html")
