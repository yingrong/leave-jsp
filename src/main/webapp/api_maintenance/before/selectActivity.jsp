...
<%@ page import="com.tw.api_maintenance.before.TeamBuildingPackageItemDto" %>
<%@ page import="com.tw.api_maintenance.before.ActivityItemDto" %>
...
<head>
    ...
    <script type="text/javascript" src="/api_maintenance/before/config.js"></script>
    <script type="text/javascript" src="/api_maintenance/before/activityInfoRow.js"></script>
...
<script>
    ...
    function checkMutexActivity(packageItemId, activityItemId) {
        ...
        $.ajax({
            url: "/api-maintenance/before?sAction=check-mutex",
            data: requestBody,
            dataType: "json",
            async: false,
    ...
    function createActivity(activityInfoRow, packageItemId, activityItemId) {
        ...
        $.ajax({
            url: "/api-maintenance/before?sAction=select",
            data: requestBody,
            async: false,
            success: function () {
                result.success = true;
    ...
    function cancelActivity(packageItemId, activityItemId) {
        ...
        $.ajax({
            url: "/api-maintenance/before?sAction=unselect",
            data: requestBody,
            async: false,
            success: function () {
