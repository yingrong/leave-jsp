...
<head>
    ...
    <meta name="description" content="Java 中 复杂对象 转成 Javascript 对象, IE11 兼容版">
...
<hr>
<div>
    <p>VUE 在 IE11 中不能使用模版字符串语法</p>
    <p>其他语法是否支持需要可以在MDN查询</p>
</div>
</body>
...
<div>\
        ...
        <select name="selectNameVue" id="s1">\
            <option :value="h.name" v-for="h in hellos" :selected="h.name[0] == \'d\'">{{ h.name }}</option>\
        </select>\
</div>\
        '
    })
